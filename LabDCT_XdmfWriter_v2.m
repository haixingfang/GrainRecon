...
% version 2.0, including Dismedian
function LabDCT_XdmfWriter_v2(FileFolder,Dream3D_FileName,Xdmf_FileName)
...
fileID=fopen(fullfile(FileFolder,Xdmf_FileName),'wt');
    ...
    fprintf(fileID,'    <Attribute Name="Dismedian" AttributeType="Scalar" Center="Cell">\n');
    fprintf(fileID,['      <DataItem Format="HDF" ',ScalarDimensionsStr,' NumberType="Float" Precision="4" >', ...
        Dream3D_FileName,':','/DataContainers/GM3D/CellData/Dismedian','</DataItem>\n']);    
    fprintf(fileID,'    </Attribute>\n');
