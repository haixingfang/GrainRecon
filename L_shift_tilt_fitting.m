...
% Oct 28, 2021
function [ParaFit,fval]=L_shift_tilt_fitting(SpotsPair,S,B,P0y,P0z,pixelysize,pixelzsize, ...
    ...
    case 'FitWithouTilts'
        ...
        ErrMean=@(x)geo_fitting(x,SpotsPair,S,B,P0y,P0z,pixelysize,pixelzsize,dety0,detz0,tilt_x,tilt_y,tilt_z);
    ...
    case 'FitAllOnce'
        ...
        ErrMean=@(x)geo_fitting(x,SpotsPair,S,B,P0y,P0z,pixelysize,pixelzsize,dety0,detz0);
%         LB=[max([x0(1)-5 0]) max([x0(2)-5 0]) -pixelysize*100 -pixelzsize*100 -5 -5 -5];
%         UB=[x0(1)+5 x0(2)+5 pixelysize*100 pixelzsize*100 5 5 5];
        LB=[max([x0(1)-1 0]) max([x0(2)-1 0]) dety00-pixelysize*50 detz00-pixelzsize*50 tilt_x-0.5 tilt_y-0.5 tilt_z-0.5];
        UB=[x0(1)+1 x0(2)+1 dety00+pixelysize*50 detz00+pixelzsize*50 tilt_x+0.5 tilt_y+0.5 tilt_z+0.5];
%         opts=optimset('Display','iter','Algorithm','trust-region-reflective', ...
%             'MaxFunEvals',2000,'MaxIter',500,'TolFun',1e-10,'PlotFcns','optimplotfval');
        opts=optimset('Display','iter','Algorithm','trust-region-reflective', ...
    ...
    case 'FitAll2Steps'
        ...
        pixelysize,pixelzsize,dety0,detz0,ParaFit1(1),ParaFit1(2),ParaFit1(3),ParaFit1(4),ParaFit1(5),ParaFit1(6));
        LB=[-5 -5 -5];
        UB=[5 5 5];
        opts=optimset('Display','iter','Algorithm','trust-region-reflective', ...
            'MaxFunEvals',2000,'MaxIter',500,'TolFun',1e-10,'PlotFcns','optimplotfval');
...
function ErrMean=det_tilt_fitting(x,hittedSpots_pair,S,B, ...
    pixelysize,pixelzsize,dety0,detz0,Lsam2sou,Lsam2det,P0y,P0z,dety00,detz00)
